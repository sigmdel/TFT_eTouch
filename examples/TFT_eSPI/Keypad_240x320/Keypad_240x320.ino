/*
  ...
  This a modification of TFT_eSPI/examples/320 x 240/Keypad_240x320/
  Keybpad_240x320.ino which optionally uses the TFT_eTouch library 
  by Achill Hasler https://github.com/achillhasler/TFT_eTouch. 

  It is easier to use a fork at https://github.com/sigmdel/TFT_eTouch
  to run this example on a ESP32_2432S028 dev board 
   ( aka 'cheap yellow display' 
     https://github.com/witnessmenow/ESP32-Cheap-Yellow-Display )
  or with a display that assigns a second PSI peripheral to the 
  touch controller. See README_2026-06-15.md in that repository for 
  details.

  Tested with ESP32_2432S028 dev board using Brain Lough (witnessmenow)
  TFT_eSPI/User_Setup.h configuration file at
...
#define BPIN 22   // Active buzzer connection: + to GPIO BPIN and - to GND  
#define BDELAY 5
